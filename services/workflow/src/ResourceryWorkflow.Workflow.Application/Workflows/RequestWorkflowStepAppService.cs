...
public class RequestWorkflowStepAppService : WorkflowAppService, IRequestWorkflowStepAppService
{
    private readonly IRequestWorkflowStepRepository _stepRepository;

    public RequestWorkflowStepAppService(
        IWorkflowRepository workflowRepository,
        IWorkflowStepRepository workflowStepRepository,
        IRequestWorkflowStepRepository stepRepository)
    ...
    {
        var entity = new RequestWorkflowStep(GuidGenerator.Create(), input.RequestWorkflowId, input.WorkflowStepId, input.AssignedToUserId);
    ...
    public async Task<RequestWorkflowStepDto> UpdateAsync(Guid id, CreateUpdateRequestWorkflowStepDto input)
    {
        ...
        entity.SetWorkflowStep(input.WorkflowStepId);
