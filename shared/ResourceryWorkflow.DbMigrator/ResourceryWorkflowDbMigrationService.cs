...
public class ResourceryWorkflowDbMigrationService(
    ILogger<ResourceryWorkflowDbMigrationService> logger,
...
) : ITransientDependency
{
    ...
    private readonly ILogger<ResourceryWorkflowDbMigrationService> _logger = logger;
